...
namespace PracticaLista
{
    class Materia
    {
        ...
        public Materia(string clave, string nombre, int calificacionPrimerParcial, int calificacionSegundoParical, int calificacionTerecerParcial, int calificacionFinal)
        {
            Clave = clave;
            Nombre = nombre;
            CalificacionPrimerParcial = calificacionPrimerParcial;
            CalificacionSegundoParcial = calificacionSegundoParical;
            CalificacionTercerParcial = calificacionTerecerParcial;
